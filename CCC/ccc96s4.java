		...
		for (int i = 0; i < t; i++) {
			...
			for (int j = 0; j < s.length(); j++) {
				...
				if (cur.equals('+')) {
					...
					if (cur.equals('V') && prev.equals('I')) {
						total -= 1;
					}
					if (cur.equals('X') && prev.equals('I')) {
						total -= 1;
					}
					if (cur.equals('L') && prev.equals('X')) {
						total -= 10;
					}
					if (cur.equals('C') && prev.equals('X')) {
						total -= 10;
					}
					if (cur.equals('D') && prev.equals('C')) {
						total -= 100;
					}
					if (cur.equals('M') && prev.equals('C')) {
						total -= 100;
					}
