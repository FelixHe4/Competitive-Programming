...
public class GiantAnts {
	...
	public static void main(String[] args) throws IOException{
		...
		Arrays.fill(goodDist, Integer.MAX_VALUE); Arrays.fill(badDist, Integer.MAX_VALUE);
		...
		for(int i = 1; i<=N; i++) if(badDist[i] != Integer.MAX_VALUE) badDist[i] *= 4;
		...
		if(goodDist[N] == Integer.MAX_VALUE) System.out.println("sacrifice bobhob314"); 
